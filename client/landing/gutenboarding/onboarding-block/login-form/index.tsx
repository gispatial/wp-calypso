...
const SignupForm = () => {
	...
	const { getAccountType } = useDispatch( USER_STORE );
	const { shouldShowPasswordField } = useSelect( select =>
		select( USER_STORE ).shouldShowPasswordField()
	);
	...
	const handleLogin = ( event: React.FormEvent< HTMLFormElement > ) => {
		...
		getAccountType( {
			usernameOrEmail: usernameOrEmailVal,
		} );
